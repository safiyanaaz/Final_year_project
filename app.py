...
def text():
	...
	if "retrieve" in start:
		...
		audio_name="test"
		audioo="{0}.wav".format(audio_name)
...
def predict():
	...
	os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = r'text-1234-274715-0c5ad90efedb.json'
	...
	with sr.Microphone() as source:
		...
		text_audio_name=r1.recognize_google(audio_name,show_all=False,language='en-IN')
